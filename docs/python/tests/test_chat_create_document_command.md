# tests/test_chat_create_document_command.py
...
- Ruta real: `tests/test_chat_create_document_command.py`
- Tipo: `test`
- Ámbito: `suite de pruebas`
- Módulo lógico: `tests.test_chat_create_document_command`

## Símbolos principales

- Clases: `ChatCreateDocumentCommandTests`
...
- Paquetes o módulos externos detectados: `fastapi`, `json`, `pathlib`, `tempfile`, `unittest`
