# tests/test_chat_temperature_contract.py
...
- Ruta real: `tests/test_chat_temperature_contract.py`
- Tipo: `test`
- Ámbito: `suite de pruebas`
- Módulo lógico: `tests.test_chat_temperature_contract`

## Símbolos principales

- Clases: `ChatTemperatureContractTests`
