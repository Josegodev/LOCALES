...
- Ruta real: `tests/test_frontend_api_client_static.py`
- Tipo: `test`
- Ámbito: `suite de pruebas`
- Módulo lógico: `tests.test_frontend_api_client_static`

## Símbolos principales

- Clases: `FrontendApiClientStaticTests`
...
- Paquetes o módulos externos detectados: `pathlib`, `unittest`
