...
- Ruta real: `tests/test_schemas_contract.py`
- Tipo: `test`
- Ámbito: `suite de pruebas`
- Módulo lógico: `tests.test_schemas_contract`

## Símbolos principales

- Clases: `SchemasContractTests`
...
- Paquetes o módulos externos detectados: `pydantic`, `unittest`
