...
- Ruta real: `tests/test_dev_token_auth.py`
- Tipo: `test`
- Ámbito: `suite de pruebas`
- Módulo lógico: `tests.test_dev_token_auth`

## Símbolos principales

- Clases: `DevTokenAuthTests`

## Dependencias internas directas

- [[python/app/main|app/main.py]]: importa `app.main`, `app.main.app`.
...
- Paquetes o módulos externos detectados: `fastapi`, `pathlib`, `unittest`
