...
- Ruta real: `tests/test_chat_only_runtime.py`
- Tipo: `test`
- Ámbito: `suite de pruebas`
- Módulo lógico: `tests.test_chat_only_runtime`

## Símbolos principales

- Clases: `ChatOnlyRuntimeTests`

## Dependencias internas directas

- [[python/app/llm_client|app/llm_client.py]]: importa `app.llm_client`.
