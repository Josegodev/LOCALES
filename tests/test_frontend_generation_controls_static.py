...
class FrontendGenerationControlsStaticTests(unittest.TestCase):
    ...
    def test_frontend_exposes_generation_controls_and_payload_fields(self):
        ...
        self.assertIn('type="range"', frontend_html)
        ...
        self.assertIn(".range-row {", frontend_css)
        ...
        self.assertIn("renderTopPValue(normalized);", frontend_js)
        self.assertIn("renderTopKValue(normalized);", frontend_js)
